  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      if (data.dniFrente?.length) {
        const respData = (
          await FilesService.fileUpload(data.dniFrente[0])
        ).data;
        if (respData.length) storeImageFront = respData[0];
      }
      if (data.dniDorso?.length) {
        const respData = (
          await FilesService.fileUpload(data.dniDorso[0])
        ).data;
            ...
            <div>
              ...
              >
                ...
                <input
                  ...
                  placeholder="Ingresa el numero del establecimiento"
                />
                <p style={{ color: 'red' }}>
                ...
                >
                  <div>
                    <div className="txtlabel signup">
                      <h2>
                        DECLARACIÓN JURADA SOBRE LA CONDICIÓN DE
                      ...
                      <div>
                        ...
                        >
                          ...
                          juramento que los datos consignados en
                          la presente son correctos, completos y
                          fiel expresión de la verdad, y que
                          SI/NO se encuentra incluido y/o
                          alcanzado dentro de la "Nómina de
                          Personas Expuestas Políticamente"
                          aprobada por la Unidad de Información
                          Financiera, que ha leído. Además, asume
                          el compromiso de informar en forma
                          fehaciente cualquier modificación que
                          se produzca en los datos consignados,
                          dentro de los treinta (30) días de
                          ocurrida, mediante la presentación de
                      ...
                      <label style={{ lineHeight: '30px' }}>
                        No, detallaré a continuación el motivo,
                        especificando artículo e inciso que lo
                        comprende
                      </label>
                    </div>
                    <div>
                  ...
                  >
                    <div>
                      ...
                      <div>
                        <p>
                          ...
                          juramento que los datos consignados en
                          la presente son correctos, completos y
                          fiel expresión de la verdad, y SI/NO se
                          encuentra alcanzado como Sujeto
                          Obligado conforme el artículo 20 de la
                          ley 25.246, sus modificatorias y
                          complementarias. En caso de estar
                          alcanzado como Sujeto Obligado, y en
                          cumplimiento con lo establecido en el
                          artículo 21 de la Ley 25.246, sus
                          modificatorias y complementarias, el
                          abajo firmante declara bajo juramento
                          que da debida observancia a las
                          disposiciones vigentes en materia de
                          Prevención del Lavado de Activos y
                          Financiación del Terrorismo, por lo
                          cual: l Tiene conocimiento del alcance
                          y propósitos establecidos en la Ley
                          25.246, sus modificatorias y
                          complementarias, y de las resoluciones
                          emitidas por la Unidad de Información
                          financiera (UIF), y cumple con la
                          mencionada normativa. l Tiene
                          conocimiento de la responsabilidad,
                          como sujeto obligado, a informar a la
                          UIF la existencia de operaciones
                          sospechosas. Además, asume el
                          compromiso de informar en forma
                          fehaciente cualquier modificación que
                          se produzca en los datos consignados,
                          dentro de los treinta (30) días de
                          ocurrida, mediante la presentación de
                          una nueva declaración jurada. (*) En
                          caso afirmativo remitir Constancia de
                          Inscripción UIF a
                    ...
                    >
                      ...
                      >
                        Me encuentro alcanzado como sujeto
                        obligado
                      </label>
                    ...
                    <div style={{ marginTop: '24px' }}>
                      <p>
                        Quien suscribe, solicita ingresar a la
                        Mutual Universitarios de Rosario en la
                        categoría de Socio Adherente, aceptando
                        las condiciones establecidas en el
                        Estatuto Social y Reglamentos, declarando
                        bajo juramento que los datos consignados
                        en la presente son fiel expresión de la
                        verdad
                      </p>
                    </div>
                    <div style={{ marginTop: '24px' }}>
